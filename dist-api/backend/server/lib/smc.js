...
exports.VALID_SMC_SYMBOLS = void 0;
exports.normalizeSmcSymbol = normalizeSmcSymbol;
exports.aggregateCandles = aggregateCandles;
exports.buildSmcReport = buildSmcReport;
exports.VALID_SMC_SYMBOLS = ['EURUSD', 'GBPUSD', 'XAUUSD'];
...
function normalizeSmcSymbol(symbol) {
    ...
    return exports.VALID_SMC_SYMBOLS.includes(corrected)
        ? corrected
        : null;
}
...
function determineBias(highs, lows, candles) {
    ...
    if (higherHigh && higherLow && close >= lastLows[1].level)
        return 'bullish';
    if (lowerHigh && lowerLow && close <= lastHighs[1].level)
        return 'bearish';
    return 'neutral';
}
