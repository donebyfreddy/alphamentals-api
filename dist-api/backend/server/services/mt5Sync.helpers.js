...
exports.normalizeOpenPositions = normalizeOpenPositions;
exports.normalizeClosedTrades = normalizeClosedTrades;
exports.inferTradingSession = inferTradingSession;
exports.estimatePips = estimatePips;
exports.buildTradeAnalysis = buildTradeAnalysis;
...
function estimatePips(symbol, direction, entryPrice, closePrice) {
    if (closePrice == null || !Number.isFinite(entryPrice) || !Number.isFinite(closePrice))
        return null;
